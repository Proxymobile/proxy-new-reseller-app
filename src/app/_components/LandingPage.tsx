          ...
          <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-3">
            ...
            <div className="rounded bg-[var(--color-bg)] border border-[var(--color-border)] px-2 py-1.5">
              <code className="text-[8px] text-[var(--color-primary)] break-all">
                {`http://pm_69fb...-mbl-us-rot-sticky:pmk_a8f2...@${gatewayDisplayEndpoint()}`}
              </code>
            </div>
          </div>
        </div>
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                High-Performance Mobile Proxies
                <br />
                <span className="text-gradient">Real 4G/5G LTE Carrier IPs</span>
              </motion.h1>
      ...
      <footer className="relative z-10 border-t border-[var(--color-border)] px-6 py-12 bg-[var(--color-surface)]">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <nav id="locations" className="lg:col-span-2 scroll-mt-20" aria-label="Mobile proxy locations">
              <h2 className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--color-text)]">
                Mobile Proxy Locations
              </h2>
            ...
            {/* Company */}
            <nav className="lg:col-span-1" aria-label="Company">
              <h2 className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--color-text)]">
                Company
              </h2>
              <ul className="mt-3 space-y-2">
                ...
                <li>
                  <Link href="/privacy" className="text-xs text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition-colors">Privacy Policy</Link>
                </li>
              </ul>
            </nav>
          </div>
